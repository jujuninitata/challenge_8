...
function apply(app) {
  ...
  app.put("/v1/cars/:id", authenticationController.authorize(accessControl.CUSTOMER), carController.handleUpdateCar);
  app.delete("/v1/cars/:id", authenticationController.authorize(accessControl.CUSTOMER), carController.handleDeleteCar);
